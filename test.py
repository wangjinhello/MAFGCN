...
parser.add_argument('--save_dir', type=str, default='/home/fiona/文档/best_model/best_model_rest_bert.pt', help='Root dir for saving models.')
...
parser.add_argument('--second_layer', default='nomax', type=str)
...
test_batch = DataLoader('./dataset/'+args.dataset+'/test2.json', args.batch_size, args, dicts)
